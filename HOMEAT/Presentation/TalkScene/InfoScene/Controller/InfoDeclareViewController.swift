//
//  InfoDeclareViewController.swift
//  HOMEAT
//
...
class InfoDeclareViewController: BaseViewController {
    var infoTalkId: Int?
    //MARK: - Property
    ...
    @objc func optionActtion(_ sender: UIButton) {
        guard let infoTalkId = self.infoTalkId else {return}
        let nextVC = InfoDeclareWriteViewController(infoTalkId: infoTalkId)
