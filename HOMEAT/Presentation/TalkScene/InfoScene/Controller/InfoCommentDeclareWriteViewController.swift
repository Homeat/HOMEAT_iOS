//
//  InfoCommentDeclareWriteViewController.swift
//  HOMEAT
//
...
class InfoCommentDeclareWriteViewController: BaseViewController {
    ...
    @objc func declareSendAction() {
        ...
        if let commentId = commentId {
            let bodyDTO = ComplainCommentRequestBodyDTO(commentId: commentId)
            NetworkService.shared.infoTalkService.complainComment(bodyDTO: bodyDTO) { response in
                switch response {
...
extension InfoCommentDeclareWriteViewController: UITextFieldDelegate, UITextViewDelegate {
